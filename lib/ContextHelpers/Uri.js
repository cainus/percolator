...
UriContextHelper.prototype.queryClear = function(url){
  url = url || this._self;
  var path = this.parse(url).pathname;
  return this.absolute(path);
};
UriContextHelper.prototype.queryMerge = function(mergeObject, url){
  url = url || this._self;
...
UriContextHelper.prototype.child = function(suffix){
  var path = this.parse(this._self).pathname;
